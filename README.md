...
[추가]
- [DTS/10량] SRT
- [DTS/10량] KTX-산천 120000호대 시안 2 / 기존 호남고속철도 시안2 재추가
- [DTS/10량] KTX-산천 120000호대 시안 3 / 기존 호남고속철도 시안3 재추가
- [DTS/10량] KTX-산천 B타입
- [DTS/20량] KTX-산천 중련

[변경]
- [DTS/10량] KTX-산천 호남고속철도 시안2->KTX-산천 A타입 초기분 / 그래픽 강제 변경
- [DTS/10량] KTX-산천 호남고속철도 시안3->KTX-산천 A타입 후기분 / 그래픽 강제 변경
- [사운드] TOSHIBAGTOKStrart 교체
- [DTS] HSR-350X / 열차 객차 길이 조정, 사운드 추가
- [DTS] KTX-산천 그룹화
```
## 인게임 등록
```
